...
export const getRiskCategory = (finalScore) => {
    if (finalScore <= 40)
...
export const getPriorityDomains = (domainPercentages) => {
...
export const getMainIndicationByPriorityDomains = (priorityDomains, finalScore) => {
    if (finalScore <= 40) {
        return null;
    }
...
export const getIndicationSummary = (category, priorityDomains) => {
...
export const getGeneralRecommendationText = (category, priorityDomains) => {
    if (category === "Risiko Rendah") {
...
export const getResultDescription = (finalScore, category, priorityDomains, domainPercentages) => {
    if (priorityDomains.length > 1) {
        const domainLabels = priorityDomains
...
export const getScreeningQuestionsByAgeMonth = async (ageMonth) => {
...
//# sourceMappingURL=screeningHelper.js.map